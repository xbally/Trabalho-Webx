...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Visualizar Categoria de Produto</title>
    ...
    <body>
        ...
        <div class="container">
            <h1>Visualizar Categoria de Produto</h1>
            <div class="form-row mt-4">
                <div class="form-group col-md-10 offset-md-1">
                    <label for="nome">Nome:</label>
                    <input class="form-control" type="text" name="nome" maxlength="100" value="<c:out value="${categoria.nome}"/>" disabled/><br/>
                </div>
            </div>
