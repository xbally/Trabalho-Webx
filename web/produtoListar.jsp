    ...
    <div class="container">
        ...
        <div class="row mt-2 mb-4">
            <div class="col-md-3 offset-md-1">
              <a class="btn btn-outline-success" href="ProdutoServlet?action=formNew">Novo Produto</a>  
            </div>
        </div>
        <c:choose>
            ...
            <div class="col-md-10 offset-md-1">
                ...
                <c:forEach items="${produtos}" var="produto">
                    <tr>
                        ...
                        <td><fmt:formatNumber value="${produto.peso}" type="number" maxFractionDigits="2"/></td>
                        <td><a href="ProdutoServlet?action=show&id=<c:out value="${produto.id}"/>"><i class="fas fa-eye"></i></a></td>
                        <td><a href="ProdutoServlet?action=formUpdate&id=<c:out value="${produto.id}"/>"><i class="fas fa-edit"></i></a></td>
                        <td><a class="confirmation" href="ProdutoServlet?action=remove&id=<c:out value="${produto.id}"/>"><i class="fas fa-trash"></i></a></td>
                    </tr>
                </c:forEach>
                </table>
            </div>
